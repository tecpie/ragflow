...
CASES = [
    ...
    (
        "deepseek",
        {
            ...
            "chunks": [
                "<think>",
                "We need to respond to the user's greeting ",
                '"hello". The assistant should be friendly and helpful. ',
                "A simple greeting back is appropriate, perhaps with an offer of assistance.",
                "</think>",
                "Hello",
                "!",
                " How",
    ...
    (
        "deepseek_repeat",
        {
            ...
            "chunks": [
                "<think>",
                'We need to respond to the user\'s "hello" again. ',
                'The user just said "hello" after I already responded. ',
                "Possibly they're testing or just greeting again. ",
                "I'll respond in a friendly manner, perhaps acknowledging the repeated greeting ",
                "and inviting them to ask something.",
                "</think>",
                "Hello",
                " again",
                "!",
