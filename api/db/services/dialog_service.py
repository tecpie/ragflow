...
def get_models(dialog, trace_context=None, langfuse_session_id=None, user_id=None):
    embd_mdl, chat_mdl, rerank_mdl, tts_mdl = None, None, None, None
    bundle_kw = {}
    if user_id:
        bundle_kw["user_id"] = str(user_id)
    if trace_context:
        bundle_kw["trace_context"] = trace_context
    if langfuse_session_id:
        bundle_kw["langfuse_session_id"] = langfuse_session_id
    ...
    if embedding_list:
        ...
        embd_mdl = LLMBundle(embd_owner_tenant_id, embd_model_config, **bundle_kw)
        if not embd_mdl:
