...
async def session_completion(chat_id_in_arg=""):
    ...
    pass_all_history_messages = get_bool_request_flag(req, "pass_all_history_messages", "pass_all_history", default=False)
    store_history_messages = get_bool_request_flag(req, "store_history_messages", "store_history", default=True)
