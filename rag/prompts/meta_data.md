...
## Rules:
 ...
 - Enum with descriptions: When the schema lists allowed values with extra text in the field `description`, use that text to choose the best match; output only a scalar from `enum`.
